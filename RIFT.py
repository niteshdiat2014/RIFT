...
def extfiles():
    ...
    dirs=["/root/","/etc/default/","/etc/network","/var/log/", "/var/tmp/", "/etc/wpa_supplicant/"]
    #,"/root/", "/home/","/var/"]# "/etc/"]#, "/var/log/","/etc/"]
...
def cmndout():
    ...
    #"dmidecode -t bios", "dmidecode -t system","dmidecode -t baseboard", "dmidecode -t chassis"
    for i in dirs:
        filei=i.replace(" ", "")
        filei=filei.replace("|", "")
        filei=filei.replace("/", "")
